...
#define VOL_1000 1000000
	...
	if (On) {
		...
		if ((pinSetIdx == 0) && currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV2680_MIPI_RAW, currSensorName))) {
		...
		}else if ((pinSetIdx == 1) && currSensorName && (0 == strcmp(SENSOR_DRVNAME_OV2681_MIPI_RAW, currSensorName))) {
			/* First Power Pin low and Reset Pin Low */
			if (GPIO_CAMERA_INVALID != pinSet[1 - pinSetIdx][IDX_PS_CMPDN])
				mtkcam_gpio_set((1 - pinSetIdx), CAMPDN,
						pinSet[1 - pinSetIdx][IDX_PS_CMPDN + IDX_PS_OFF]);
