...
#define PFX "OV2681"
#define LOG_1 LOG_INF("OV2681,MIPI 1LANE\n")
...
static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = 0x2681,//0x2680, //OV2681MIPI_SENSOR_ID,  /*sensor_id = 0x2681*/ //record sensor id defined in Kd_imgsensor.h
...
/*according toov2681 datasheet p53 image cropping*/
...
static void set_dummy(void)
{
	...
	/*  Add dummy pixels: */
    /* 0x380c [0:4], 0x380d defines the PCLKs in one line of OV2681  */  
    /* Add dummy lines:*/
    /* 0x380e [0:1], 0x380f defines total lines in one frame of OV2681 */
...
/*UINT32 OV2681_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)*/
UINT32 OV2681MIPISensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
