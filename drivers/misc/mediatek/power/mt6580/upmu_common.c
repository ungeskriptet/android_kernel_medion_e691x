...
unsigned short mt6350_upmu_set_rg_vgp1_volse(unsigned int val)
{
       	return mt6350_set_register_value(PMIC_RG_VGP1_VOSEL, val);
}

unsigned short mt6350_upmu_set_rg_vgp1_en(unsigned int val)
{
       	return mt6350_set_register_value(PMIC_RG_VGP1_EN, val);
}
